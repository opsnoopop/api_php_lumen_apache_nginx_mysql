# Nginx PHP-Apache Lumen API with MySQL

A simple Nginx PHP-Apache Lumen API application and MySQL, containerized with Docker.
...
```bash
git clone https://github.com/opsnoopop/api_php_lumen_apache_nginx_mysql.git
```

### 2. Navigate to Project Directory
```bash
cd api_php_lumen_apache_nginx_mysql
```
